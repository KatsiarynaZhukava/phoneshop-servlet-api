...
public class ArrayListProductDaoTest
{
    ...
    public void setup() {
        ...
        if (productDao.findProducts(null, null, null).isEmpty()) {
            productDao.save(new Product("sgs", "Samsung Galaxy S", new BigDecimal(100), usd, 100, "https://github.com/andrewosipenko/phoneshop-ext-images/blob/master/manufacturer/Samsung/Samsung%20Galaxy%20S.jpg?raw=true", new HashMap<LocalDate, BigDecimal>(){{ put(LocalDate.of(2021, Calendar.JUNE, 30), new BigDecimal(200)); put(LocalDate.now(), new BigDecimal(100)); }} ));
