...
public final class Messages {
    ...
    public static final String PRODUCT_OUT_OF_STOCK_WITHOUT_ITEMS_IN_CART = "Not enough stock, available {0}";
    public static final String QUANTITY_NON_POSITIVE_VALUE = "The quantity value must be > 0";
    public static final String QUANTITY_TOO_LARGE = "The quantity value is too large";
}
