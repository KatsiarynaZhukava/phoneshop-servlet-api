...
public class DemoDataServletContextListener implements ServletContextListener {
    ...
    private List<Product> getSampleProducts() {
        ...
        result.add(new Product(null, "sgs", "Samsung Galaxy S", new BigDecimal(1000), usd, 100, "https://github.com/andrewosipenko/phoneshop-ext-images/blob/master/manufacturer/Samsung/Samsung%20Galaxy%20S.jpg?raw=true", new HashMap<LocalDateTime, BigDecimal>(){{ put(LocalDateTime.of(2021, Calendar.JUNE, 30, 10, 2, 3), new BigDecimal(200)); put(LocalDateTime.now(), new BigDecimal(100)); }} ));
